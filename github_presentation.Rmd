...
```{bash eval=F, echo=T}  
git pull origin master --allow-unrelated-histories # unnecessary parallel history merged to your project, 
# usually associated with a README.md file
```
If VIM opens, type 'SHIFT + :'  
...
# see what remote repo you have. if a github one exists, you can push
git remote -v  
