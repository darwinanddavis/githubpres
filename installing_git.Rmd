...
If you don't see anything like `git version 2.10.0`, try the reinstallation steps again.
...
If you don't see anything like `git version 2.20.1.windows.1`, try the reinstallation steps again.
