---
title: "Using `git` for research and life | **Part I**"
...
## What the hell is `git` and Github? {.build}         
...
[Go to Part II](https://darwinanddavis.github.io/githubpres/github_presentation_part2.html#1)  
